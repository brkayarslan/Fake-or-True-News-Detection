...
data_fake = pd.read_csv(r"C:\Users\user\Desktop\Django-FN-Sonn-main\Fnapp\sorgu\datasetss\Fake.csv")
data_true = pd.read_csv(r"C:\Users\user\Desktop\Django-FN-Sonn-main\Fnapp\sorgu\datasetss\True.csv")
toc = time.perf_counter()
